...
import {
  ApiAddPlaylistToCategory,
  ApiAllPlaylist,
  ApiAllSong,
  ApiFindAllSOng,
} from "../api/indext";
import {
  removePlaylistSelected,
  resetListPlaylistSelected,
  updateListPlaylistSelected,
  useAppContext,
      ...
      <Modal.Body>
        <div className="input-search" style={{ width: "100%", height: "50px" }}>
          ...
          <input
            ...
            onChange={handleFilterSong}></input>
        </div>
        ...
        <table
          className="table table-dark border table-hover table-responsive"
          style={{ marginTop: 60 }}>
          <thead>
            <tr>
              <th>ID</th>
                    ...
                    <td>
                      {handleCheckSongSelected(item.id) === false ? (
                        <button
                          className="btn btn-success"
                          onClick={() => {
                            dispatch(updateListPlaylistSelected(item.id));
                          }}>
                          Chọn
                        </button>
                      ) : (
                        <button
                          ...
                          onClick={() => {
                            dispatch(removePlaylistSelected(item.id));
                          }}>
                          Đã chọn
                        </button>
                      )}
